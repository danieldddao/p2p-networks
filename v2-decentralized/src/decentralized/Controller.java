...
import decentralized.Components.MessageType;
import decentralized.Components.Node;

import decentralized.Components.Utils;
import decentralized.Runnable.Download;
                ...
                if (dir != null) {
                    try {
                        ...
                        if (response == MessageType.BOOK_IS_AVAILABLE) {
                            ...
                            Thread t = new Thread(new Download(socket, currentBook, dir, progressBar, checkBox));
                            t.start();
