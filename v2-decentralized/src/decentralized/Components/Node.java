package decentralized.Components;

import decentralized.Runnable.FixFingers;
import decentralized.Runnable.Listener;
import decentralized.Runnable.Stabilize;
...
//            System.out.println(nodeName + "- CLOSEST.PRECEDING.FINGER.OF " + ID + " is " + nodeName + ", " + address.getAddress().getHostAddress() + ":" + address.getPort());
    ...
    public Book shareABook(String title, String author, String isbn, String location) {
        try {
            ...
            String bookString = title.replaceAll("[^A-Za-z0-9]", "");
    ...
    public List<Book> searchBook(String searchTerm) {
        ...
        try {
            String searchString = searchTerm.replaceAll("[^A-Za-z0-9]", "");;
